...
static inline my_float add_f(const my_float a, const my_float b)
{
    return (a + b);
}


static inline my_float sub_f(const my_float a, const my_float b)
{
    return (a - b);
}


static inline my_float mul_f(const my_float a, const my_float b)
{
    return (a * b);
}

static inline my_float div_f(const my_float a, const my_float b)
{
    return (a / b);
}

static inline my_float mac_f(const my_float a, const my_float b, const my_float c)
{
    return (a * b) + c;
}


static inline my_float msub_f(const my_float a, const my_float b, const my_float c)
{
    return (a * b) - c;
}

static inline my_float nmsub_f(const my_float a, const my_float b, const my_float c)
{
    return c - (a * b);
}

static inline my_float pow_f(const my_float a, const my_float b)
{
    return powf(a, b);
}

static inline my_float abs_f(const my_float a)
{
    return ((a < 0) ? -a : a);
}


static inline my_float neg_f(const my_float a)
{
    return ((a < 0) ? a : -a);
}
