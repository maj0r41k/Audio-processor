    ...
    void*       coeffs)
{
    ...
    update_coeffs->comp_ch_2_coef.alphaAttack = powf(M_e, (-1.0 / (0.001*update_params->comp_ch_2_par.tauAttack*update_params->comp_ch_2_par.samplerate)));
    update_coeffs->comp_ch_2_coef.alphaRelease = powf(M_e, (-1.0 / (0.001*update_params->comp_ch_2_par.tauRelease*update_params->comp_ch_2_par.samplerate)));

    update_coeffs->comp_ch_2_coef.attackEnv = powf(M_e, (-1.0 / (0.001*update_params->comp_ch_2_par.tauEnvAtt*update_params->comp_ch_2_par.samplerate)));
    update_coeffs->comp_ch_2_coef.releaseEnv = powf(M_e, (-1.0 / (0.001*update_params->comp_ch_2_par.tauEnvRel*update_params->comp_ch_2_par.samplerate)));
    ...
    update_coeffs->comp_ch_3_coef.alphaAttack = powf(M_e, (-1.0 / (0.001*update_params->comp_ch_3_par.tauAttack*update_params->comp_ch_3_par.samplerate)));
    update_coeffs->comp_ch_3_coef.alphaRelease = powf(M_e, (-1.0 / (0.001*update_params->comp_ch_3_par.tauRelease*update_params->comp_ch_3_par.samplerate)));

    update_coeffs->comp_ch_3_coef.attackEnv = powf(M_e, (-1.0 / (0.001*update_params->comp_ch_3_par.tauEnvAtt*update_params->comp_ch_3_par.samplerate)));
    update_coeffs->comp_ch_3_coef.releaseEnv = powf(M_e, (-1.0 / (0.001*update_params->comp_ch_3_par.tauEnvRel*update_params->comp_ch_3_par.samplerate)));
    ...
    update_coeffs->comp_ch_4_coef.alphaAttack = powf(M_e, (-1.0 / (0.001*update_params->comp_ch_4_par.tauAttack*update_params->comp_ch_4_par.samplerate)));
    update_coeffs->comp_ch_4_coef.alphaRelease = powf(M_e, (-1.0 / (0.001*update_params->comp_ch_4_par.tauRelease*update_params->comp_ch_4_par.samplerate)));

    update_coeffs->comp_ch_4_coef.attackEnv = powf(M_e, (-1.0 / (0.001*update_params->comp_ch_4_par.tauEnvAtt*update_params->comp_ch_4_par.samplerate)));
    update_coeffs->comp_ch_4_coef.releaseEnv = powf(M_e, (-1.0 / (0.001*update_params->comp_ch_4_par.tauEnvRel*update_params->comp_ch_4_par.samplerate)));
