...
int main()
{
    ...
    fileAdd = "../../test_signal/in_sweep.wav";
    newFileFIR = "../../test_signal/newww.wav";

    //ptrWavFile = fopen(fileAdd, "rb");      // Open existance .wav file
    if((ptrWavFile = fopen(fileAdd, "rb")) == NULL)
    	return 0;
    if((ptrNewWavFIR = fopen(newFileFIR, "w+b")) == NULL)
    	return 0;
...
{
    FILE * js = fopen("../../chain/chain_float/parser.json", "r");
