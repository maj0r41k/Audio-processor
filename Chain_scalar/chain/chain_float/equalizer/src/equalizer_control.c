    ...
    void*       coeffs)
{
    ...
    for (int r = 0; r < 10; r++)
    {
        printf("%34.80f, ", update_coeffs->b0[r]);
    }
    printf("*\n");

    for (int r = 0; r < 10; r++)
    {
        printf("%34.80f, ", update_coeffs->b1[r]);
    }
    printf("*\n");

    for (int r = 0; r < 10; r++)
    {
        printf("%34.80f, ", update_coeffs->b2[r]);
    }
    printf("*\n");

    for (int r = 0; r < 10; r++)
    {
        printf("%34.80f, ", update_coeffs->a1[r]);
    }
    printf("*\n");

    for (int r = 0; r < 10; r++)
    {
        printf("%34.80f, ", update_coeffs->a2[r]);
    }
    printf("*\n");
